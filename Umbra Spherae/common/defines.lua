...
NCharacter = {
	...
	NATURAL_DEATH_CHANCE_AGE_0 = 50,					-- Natural deaths per decade out of 10000 people: Age 0-9
	NATURAL_DEATH_CHANCE_AGE_10 = 100,				-- Natural deaths per decade out of 10000 people: Age 10-19
	...
	SECONDARY_SPOUSE_FERTILITY_MULT = 0.15,			-- Applied to fertility of secondary spouses and concubines
	NOT_SPOUSE_FERTILITY_MULT = 0.10,				-- Applied to fertility when the two characters are not married
